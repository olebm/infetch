...
// Rendered per request, not prerendered at build: <LogoStrip/> reads live vendor
// data from Postgres and the hero shows a current timestamp. Without this the
// `next build` static export hits the no-op build DB client and fails (caught by
    ...
    <div className="overflow-x-hidden">
      ...
      <header className="sticky top-0 z-40 nav-blur border-b border-line relative">
        <div className="max-w-[1180px] mx-auto px-6 md:px-8 h-16 flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-6 ml-6 text-sm text-muted">
            ...
            <a href="#sicherheit" className="hover:text-ink">
              Sicherheit
            </a>
            <a href="#preise" className="hover:text-ink">
              Preise
            </a>
      ...
      <main>
        ...
        <section className="relative">
          <div className="max-w-[1180px] mx-auto px-6 md:px-8 pt-8 md:pt-24 pb-12 md:pb-20 grid md:grid-cols-[1fr_1.1fr] gap-12 lg:gap-14 items-center">
            <div className="min-w-0">
              ...
              <h1 className="mt-5 font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-ink leading-[1.02] max-w-[18ch]">
                ...
                <span className="whitespace-nowrap">
                  sich <span className="accent">selbst</span>
                </span>{" "}
                weiterleiten.
              </h1>
              <p className="mt-6 text-lg text-muted max-w-[42ch] leading-relaxed">
                Infetch liest dein Postfach mit, erkennt jede Rechnung und schickt sie an deine
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link
                  ...
                  className="inline-flex h-11 px-5 rounded items-center bg-ink text-white text-sm font-medium hover:opacity-90"
                >
                  Kostenlos starten
                </Link>
                <a
                  href="#how"
                  className="inline-flex h-11 px-4 rounded items-center text-sm text-ink ul-link"
                >
                  Wie es funktioniert
                </a>
              </div>
              ...
              <p className="md:hidden mt-6 text-xs text-muted">
                <span className="text-ink stat-num">≈ 4 Min</span> Einrichtung ·{" "}
                <span className="text-ink stat-num">DSGVO</span> · EU-Server ·{" "}
                <span className="text-ink stat-num">KI</span> · automatisch
              </p>
            ...
            <div className="min-w-0 flex flex-col gap-5">
              <div
                className="relative w-full rounded-lg overflow-hidden shadow-lift"
              ...
              <div className="mock-window shadow-lift">
                ...
                <ul className="px-2 pb-3">
                  {[
                    ...
                    {
                      domain: "adobe.com",
                      label: "Adobe Systems · Creative Cloud",
                      meta: "11:02 · 77,99 €",
                    },
                  ].map(({ domain, label, meta }) => (
                    <li
                      key={domain}
                      className="row-hover px-3 py-3 flex items-center gap-4 border-b border-line"
                    >
                  ...
                  <li className="relative border-b border-line" style={{ height: "68px" }}>
                    {[
                      {
                        domain: "slack.com",
                        label: "Slack Technologies · Pro",
                        meta: "jetzt · 8,75 €",
                      },
                      {
                        domain: "notion.so",
                        label: "Notion Labs · Team Plan",
                        meta: "jetzt · 16,00 €",
                      },
                      {
                        domain: "figma.com",
                        label: "Figma Inc. · Professional",
                        meta: "jetzt · 15,00 €",
                      },
                    ].map(({ domain, label, meta }, i) => (
                      <div
                        key={domain}
                        className="anim-row absolute inset-0 px-3 flex items-center gap-4"
                      ...
                      >
                        ...
                        <div className="relative" style={{ minWidth: "72px", height: "20px" }}>
                          <span
                            className="anim-badge absolute inset-0 inline-flex items-center justify-end gap-1.5 whitespace-nowrap"
                            style={{ animationDelay: `${i * 8}s` }}
                          >
                          ...
                          <span
                            className="anim-sent absolute inset-0 inline-flex items-center justify-end gap-1.5 whitespace-nowrap"
                            style={{ animationDelay: `${i * 8}s` }}
                          >
                            <span className="inline-block h-1.5 w-1.5 shrink-0 rounded-full bg-ok"></span>
                            <span className="text-xs text-muted">verschickt</span>
                ...
                <div className="px-5 py-3 border-t border-line bg-surface flex items-center justify-between text-xs text-muted">
                  <span>
                    Auto-Pilot <span className="text-ink stat-num">aktiv</span>
                  </span>
            ...
            <div className="grid md:grid-cols-[1fr_1.1fr] gap-0 md:gap-12 items-stretch">
              ...
              <div className="divide-y divide-line">
                {[
                  {
                    eyebrow: "Kein System",
                    title: "Rechnungen in jedem Postfach",
                    body: "Adobe, Hetzner, 1&1 — jeder Anbieter schickt von einer anderen Adresse, in ein anderes Postfach.",
                  },
                  {
                    eyebrow: "Zeitverlust",
                    title: "Jeden Monat manuell suchen",
                    body: "Filtern, runterladen, weiterleiten — für jede einzelne Rechnung, jeden Monat, von vorne.",
                  },
                  {
                    eyebrow: "Zu spät",
                    title: "Die Buchhaltung fragt. Du suchst.",
                    body: "Stunden damit verbracht, Belege zu finden, die längst hätten weitergeleitet sein sollen.",
                  },
          ...
          <div className="max-w-[1180px] mx-auto px-6 md:px-8">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-3 font-display text-4xl md:text-5xl text-ink leading-[1.05]">
                In vier Minuten verbunden.
                <br className="hidden md:block" /> Danach läuft alles ohne dich.
              </h2>
            </div>
            ...
            <div className="mt-14 grid md:grid-cols-3 gap-x-10 gap-y-12 reveal" id="how-steps">
              ...
              <div className="flex flex-col">
                ...
                <p className="mt-2 text-muted leading-relaxed min-h-[4.5rem]">
                  Verbinde Gmail, Outlook oder einen IMAP-Anbieter in Minuten. Zugangsdaten
                  verschlüsselt gespeichert — nie im Klartext.
                </p>
              ...
              <div className="flex flex-col">
                ...
                <p className="mt-2 text-muted leading-relaxed min-h-[4.5rem]">
                  KI liest Anbieter, Betrag und Steuersatz direkt aus dem PDF. Unsichere Erkennungen
                  warten auf dein OK.
                </p>
                <div className="mt-6 mock-window">
                  <div className="px-4 py-3 border-b border-line flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <p className="mt-2 text-muted leading-relaxed min-h-[4.5rem]">
                  Das erkannte PDF geht sofort an deinen Empfänger — ohne dein Zutun. Jeden Schritt
                  siehst du im Audit-Log.
                </p>
                <div className="mt-6 mock-window">
                  <div className="px-4 py-3 border-b border-line flex items-center gap-2">
                    <div className="text-xs text-muted">an</div>
                    <div className="text-xs text-ink font-mono truncate">
                      buchhaltung@beispiel.de
                    </div>
                  </div>
                  <div className="px-4 py-3 flex items-center justify-between text-xs">
            ...
            <div className="mt-14 pt-10 border-t border-line">
              <Link
                href="https://app.infetch.de/login"
                className="inline-flex h-12 px-8 rounded items-center bg-ink text-white text-base font-medium hover:opacity-90"
              >
          ...
          <div className="max-w-[1180px] mx-auto px-6 md:px-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-5 text-muted text-lg leading-relaxed max-w-xl">
                Kein Sammelordner, keine Excel-Liste, kein Suchen. Jede Rechnung dort, wo sie
                hingehört.
              </p>
            </div>
                    ...
                    {[
                      {
                        domain: "hetzner.com",
                        name: "Hetzner Online",
                        count: "14 Rechnungen · monatlich",
                        sum: "385,70 €",
                      },
                      {
                        domain: "microsoft.com",
                        name: "Microsoft Corporation",
                        count: "4 Rechnungen · monatlich",
                        sum: "250,00 €",
                      },
                      {
                        domain: "adobe.com",
                        name: "Adobe Systems",
                        count: "5 Rechnungen · monatlich",
                        sum: "389,95 €",
                      },
                    ...
                    {[
                      {
                        ...
                        name: "lexoffice",
                        label: "Primär",
                        email: "belege@lexoffice.de",
                      },
                      {
                        domain: "sevdesk.de",
                        name: "sevDesk",
                        label: "Sekundär",
                        email: "buchhaltung@studio.de",
                      },
            ...
            <div className="grid md:grid-cols-[1fr_1.1fr] gap-10 md:gap-20 items-start">
              <div>
                ...
                <p className="mt-5 text-muted leading-relaxed">
                  Infetch filtert gezielt auf Rechnungsmerkmale und speichert ausschließlich
                  erkannte Belege — verschlüsselt, auf Servern in Frankfurt. Dein restliches
                  Postfach bleibt unberührt, und du kannst alle Daten jederzeit vollständig löschen.
                </p>
                <div className="mt-6">
        ...
        <section className="py-20 md:py-28 border-y border-line">
          <div className="max-w-[1180px] mx-auto px-6 md:px-8">
            ...
            <div className="mt-14 grid md:grid-cols-2 gap-12">
              <div>
                ...
                <ul className="mt-5 flex flex-wrap gap-3">
                  {[
                    ...
                    <li
                      key={label}
                      className="relative group/tip h-12 w-12 logo-tile rounded-full flex items-center justify-center cursor-default overflow-hidden"
                    >
                      {domain ? (
              ...
              <div>
                <div className="text-xs uppercase tracking-[0.14em] text-muted">
                  An deine Buchhaltung — per E-Mail
                </div>
                <ul className="mt-5 flex flex-wrap gap-3">
                  {[
                ...
                <p className="mt-4 text-xs text-muted">
                  Funktioniert mit allem, was eine Beleg-Adresse hat — Xero, QuickBooks, Sage,
                  Candis und jede eigene Buchhaltungs-Mail.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="border-b border-line py-20 md:py-28">
          <div className="max-w-[1180px] mx-auto px-6 md:px-8 grid md:grid-cols-2 gap-12 items-center">
            <div
              className="relative max-w-xs mx-auto md:mx-0 w-full rounded-lg overflow-hidden"
            ...
            <div>
              ...
              <p className="mt-5 text-muted leading-relaxed">
                Infetch arbeitet im Hintergrund — auch wenn du es nicht tust. Jede Rechnung landet
                dort, wo sie hingehört.
              </p>
              <div className="mt-8">
                <Link
                  href="https://app.infetch.de/login"
                  className="inline-flex h-11 px-6 rounded items-center bg-ink text-white text-sm font-medium hover:opacity-90"
                >
                  Jetzt kostenlos starten
                </Link>
              </div>
        ...
        <section id="preise" className="py-20 md:py-28 bg-paper border-y border-line">
          <div className="max-w-[1180px] mx-auto px-6 md:px-8">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-3 font-display text-4xl md:text-5xl text-ink leading-[1.05]">
                {proEnabled
                  ...
                  : "Kostenlos. Kein Kleingedrucktes."}
              </h2>
              <p className="mt-5 text-muted leading-relaxed">
            ...
            <div
              className={`mt-14 ${proEnabled ? "grid md:grid-cols-2 gap-8 max-w-4xl" : "max-w-md"}`}
            >
              {/* Plan: Free */}
              <div className="border border-line rounded-2xl p-8 bg-white flex flex-col">
                ...
                <ul className="mt-6 space-y-3 text-sm text-ink flex-1">
                  <li className="flex items-center gap-2">
                    <span className="w-1 h-1 rounded-full bg-muted/50 shrink-0"></span>30 Rechnungen
                    / Monat
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1 h-1 rounded-full bg-muted/50 shrink-0"></span>1 Postfach
                    (IMAP)
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1 h-1 rounded-full bg-muted/50 shrink-0"></span>Auto-Pilot
                    aktiv
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1 h-1 rounded-full bg-muted/50 shrink-0"></span>500 MB
                    Speicher
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1 h-1 rounded-full bg-muted/50 shrink-0"></span>
                    E-Mail-Support
                  </li>
                </ul>
                <Link
                  href="https://app.infetch.de/login"
                  className="mt-8 inline-flex h-11 px-5 items-center justify-center rounded-lg border border-ink/30 text-sm text-ink hover:bg-surface"
                >
                  Kostenlos starten
                </Link>
              </div>
              ...
              {proEnabled && (
                <div className="border-2 border-ink rounded-2xl p-8 bg-white flex flex-col relative">
                  ...
                  <ul className="mt-6 space-y-3 text-sm text-ink flex-1">
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-ink shrink-0"></span>150 Rechnungen /
                      Monat
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-ink shrink-0"></span>Bis zu 3
                      Postfächer
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-ink shrink-0"></span>2 GB Speicher
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-ink shrink-0"></span>Export zu
                      Lexoffice &amp; sevDesk
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-ink shrink-0"></span>Retroaktiver
                      12-Monats-Scan
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-ink shrink-0"></span>Bulk-Download
                      (ZIP)
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-ink shrink-0"></span>
                      Prioritäts-Support
                    </li>
                  </ul>
                  <Link
                    href="https://app.infetch.de/login"
                    className="mt-8 inline-flex h-11 px-5 items-center justify-center rounded-lg bg-ink text-white text-sm font-medium hover:opacity-90"
                  >
                    Pro wählen
                  </Link>
                </div>
            ...
            <div className="mt-8 text-xs text-muted">
              ...
              <button type="button" data-contact="" className="ul-link">
                Sprich mit uns.
              </button>
            </div>
          </div>
      ...
      <section className="bg-ink text-white py-20 md:py-28">
        <div className="max-w-[1180px] mx-auto px-6 md:px-8 text-center">
          ...
          <h2 className="mt-3 font-display text-5xl md:text-6xl leading-[1.02] max-w-3xl mx-auto text-white">
            Du suchst seit Jahren nach Belegen.
          ...
          <div className="mt-10 flex flex-wrap justify-center items-center gap-4">
            <Link
              href="https://app.infetch.de/login"
              className="inline-flex h-12 px-6 items-center rounded bg-white text-ink text-sm font-medium hover:opacity-90"
            >
              Kostenlos starten
            </Link>
          </div>
        ...
        <div className="max-w-[1180px] mx-auto px-6 md:px-8 py-10 grid md:grid-cols-[1.2fr_repeat(3,1fr)] gap-10 md:gap-16">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-ink">
              <li>
                <a href="#how" className="hover:text-muted">
                  Wie es funktioniert
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#preise" className="hover:text-muted">
                  Preise
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-ink">
              ...
              <li>
                <a href="/ueber-uns" className="hover:text-muted">
                  Über uns
                </a>
              </li>
              <li>
                <button type="button" data-contact="" className="hover:text-muted">
                  Kontakt
                </button>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-ink">
              <li>
                <a href="/agb" className="hover:text-muted">
                  AGB
                </a>
              </li>
              <li>

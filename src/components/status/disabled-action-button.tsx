...
export function DisabledActionButton({ children, variant = "secondary", className }: DisabledActionButtonProps) {
  return (
    <button
      type="button"
      disabled
      ...
      className={cn(
        ...
        variant === "primary" ? "bg-brand text-white shadow-soft" : "border border-line bg-white text-ink",
        className,
      )}
    >
      {children}
